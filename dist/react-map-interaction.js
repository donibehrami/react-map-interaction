...
function MapInteraction_createSuper(Derived) { return function () { var Super = MapInteraction_getPrototypeOf(Derived), result; if (MapInteraction_isNativeReflectConstruct()) { var NewTarget = MapInteraction_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return MapInteraction_possibleConstructorReturn(this, result); }; }
...
var MapInteraction_MapInteraction = /*#__PURE__*/function (_Component) {
  ...
  function MapInteraction(props) {
    ...
    _this.addZoomEvents = _this.addZoomEvents.bind(MapInteraction_assertThisInitialized(_this));
    _this.addPanEvents = _this.addPanEvents.bind(MapInteraction_assertThisInitialized(_this));
    _this.removeZoomEvents = _this.removeZoomEvents.bind(MapInteraction_assertThisInitialized(_this));
    _this.removePanEvents = _this.removePanEvents.bind(MapInteraction_assertThisInitialized(_this));
    return _this;
  }
  ...
  MapInteraction_createClass(MapInteraction, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (this.props.disablePan && !prevProps.disablePan) {
        ...
        var _passiveOption = src_makePassiveEventOption(false);

        this.addPanEvents(_passiveOption);
      }
    }
  }, {
    ...
    */
    ...
    key: "addZoomEvents",
    value: function addZoomEvents(passiveOption) {
      this.getContainerNode().addEventListener('wheel', this.onWheel, passiveOption);
    }
  }, {
    key: "addPanEvents",
    value: function addPanEvents(passiveOption) {
      // start gesture
    ...
    key: "removeZoomEvents",
    value: function removeZoomEvents() {
      this.getContainerNode().removeEventListener('wheel', this.onWheel);
    }
  }, {
    key: "removePanEvents",
    value: function removePanEvents() {
      // Remove touch events
    ...
    value: function translatedOrigin() {
      ...
      var clientOffset = this.getContainerNode().getBoundingClientRect();
      return {
    ...
    value: function changeScale(delta) {
      ...
      var rect = this.getContainerNode().getBoundingClientRect();
